...
def test_point2d_rotate_by_90() -> None:
...
def test_point2d_distance_symmetric() -> None:
    a = Point2d(1.0, 2.0)
    b = Point2d(-3.0, 4.0)
    assert abs(a.distance(b) - b.distance(a)) < 1e-12


def test_point2d_ros_round_trip() -> None:
...
def test_pose2d_world_to_local_at_origin() -> None:
...
def test_pose2d_world_to_local_translation_only() -> None:
...
def test_pose2d_world_to_local_rotation_only() -> None:
...
def test_pose2d_local_to_world_round_trip() -> None:
...
def test_pose2d_ros_round_trip() -> None:
